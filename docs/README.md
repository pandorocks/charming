...
| [Testing](testing.md) | Controller, template, component, runtime, timer, and task tests. |

The top-level [README](../README.md) is intentionally short. These docs contain the detailed explanations and examples.
